...
public class LoggerMessages {
    ...
    public static final String SERVER_DB_CONNECT = "SERVER CONNECTED DATABASE";
    public static final String SERVER_DB_DISCONNECT = "SERVER NOT CONNECTED TO DATABASE";
