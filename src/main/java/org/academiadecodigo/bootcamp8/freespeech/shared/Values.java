...
public class Values {
    ...
    public static final String ACC_DELETED = "Your account was deleted. Sorry to see you go. \n" +
    ...
    public static final String REPORT_OK = "A report was sent.";
    public static final String REPORT_KO = "You already reported this user.";
    public static final String REPORTED = " Your account has been blocked.";
    ...
    public static final int MAX_REPORT_USER = 3; //TODO 3?
}
