...
public class Values {
    ...
    public static final String PASS_NOT_CHANGED = "Incorrect password.\nNot able to change your password.";
    ...
    public static final String ACC_DELETED = "Your account was deleted.\nWe are sorry to see you go.\nCome back when you get tired of Slack Police!";
    ...
    public static final String BIO_NOT_UPDATED = "Unable to update bio.\nWe are experiencing database issues at the moment.\nPlease try later on.";
    public static final String REPORT_OK = "User successfully reported.";
    public static final String REPORT_KO = "You already reported this user.";
    public static final String REPORTED = "This user has been blocked.";
